...
namespace McTicaret.Module.BusinessObjects
{
    ...
    public class Sehirler : XPObject
    {
        ...
        public override void AfterConstruction()
        {
            ...
            XPCollection<Sehirler> collection = new XPCollection<Sehirler>(Session);
        ...
        [Association]
        public XPCollection<Ilceler> Ilcelerim => GetCollection<Ilceler>(nameof(Ilcelerim));
        ...
        public new class FieldsClass : XPObject.FieldsClass
        {
            ...
            public const string IlcelerimFieldName = "Ilcelerim";

            public OperandProperty Ilcelerim
            {
                get
                {
                    return new OperandProperty(GetNestedName(IlcelerimFieldName));
                }
            }
        }
