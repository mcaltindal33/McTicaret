...
namespace McTicaret.Module.BusinessObjects
{
    ...
    public class AlisIrsaliye : StokIslemler
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public AlisIrsaliye(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            Turu = EvrakTurleri.AlimIrsaliye;
            Islem = IslemTurleri.Irsaliye;
            Hareket = StokHareketTuru.StokGirisi;
            Tarih = DateTime.Now;
            XPCollection<AlisIrsaliye> collection = new XPCollection<AlisIrsaliye>(Session);
