...
namespace McTicaret.Module.BusinessObjects
{
    ...
    public class KasadanBaknaya : KasaBankaHareketler
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public KasadanBaknaya(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            KasaHarekets = KasaHareketTuru.KasaCikisi;
            BankaHarekets = BankaHareketTuru.BankaGirisi;
            Islem = IslemTurleri.Transfer;
            Turu = EvrakTurleri.KasadanBaknayaYatan;
            Tarih = DateTime.Now;
            XPCollection<BankaTahsilat> collection = new XPCollection<BankaTahsilat>(Session);
        ...
        public new class FieldsClass : KasaBankaHareketler.FieldsClass
        {
            public FieldsClass()
            {
