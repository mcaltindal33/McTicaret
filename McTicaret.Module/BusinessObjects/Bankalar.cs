...
namespace McTicaret.Module.BusinessObjects
{
    ...
    public class Bankalar : XPObject
    {
        ...
        public override void AfterConstruction()
        {
            ...
            XPCollection<Bankalar> collection = new XPCollection<Bankalar>(Session);
        ...
        [Association]
        public XPCollection<BankaSubeleri> Subeleri => GetCollection<BankaSubeleri>(nameof(Subeleri));
        ...
        public new class FieldsClass : XPObject.FieldsClass
        {
            ...
            public const string SubeleriFieldName = "Subeleri";

            public OperandProperty Subeleri
            {
                get
                {
                    return new OperandProperty(GetNestedName(SubeleriFieldName));
                }
            }
        }
