...
namespace McTicaret.Win {
    ...
    public partial class McTicaretWindowsFormsApplication : WinApplication {
        ...
        #endregion
        public McTicaretWindowsFormsApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void McTicaretWindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e) {
            string userLanguageName = System.Threading.Thread.CurrentThread.CurrentUICulture.Name;
            if(userLanguageName != "en-US" && e.Languages.IndexOf(userLanguageName) == -1) {
                e.Languages.Add(userLanguageName);
            }
        }
        private void McTicaretWindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
//#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
//#else
